...
/**
 * Servei per a la gestió de JSON Web Tokens (JWT).
 * S'encarrega de generar, analitzar i validar tokens.
 */
@Service
public class JwtService {
    ...
    public String generateToken(User user) {
        ...
        return Jwts.builder()
                ...
                .subject(user.getUsername()) // Estableix el subject (el nom d'usuari).
